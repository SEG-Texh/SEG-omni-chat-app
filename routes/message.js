...
// Get conversations using controller
...
router.get('/conversations/:sender/:recipient', authMiddleware, messageController.getConversationMessages);

// Get improved conversations grouping
router.get('/conversations/improved', authMiddleware, messageController.getConversationsImproved);
